...
- **Orphans (no home in the 6):** `phase_b/plan_review` (cross-cutting roadmap), `v6_wide_migration_roadmap` (rollout plan), `store_progression` (the narrative spine, above all buckets), `evaluation/methodology/variance_reduction_levers` (was mis-filed in metrics/ = ④; relocated 2026-07-07), `strategy_adoption/report` (triple-homed ①+③a+⑤).
