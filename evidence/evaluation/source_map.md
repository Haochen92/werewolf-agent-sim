...
| Forced-schema screen | `experiments/studies/forced_schema_screen.py`, `studies/dimension_gating_screen.py` (tested) | `phase_b/forced_schema_screen/experiment_log.md` | 🟡 **DIRECTIONAL** | safe on v6 (+0.021, N=48); coverage fix (prompt-body) 0.27→0.97; adopted, not deployed at scale |
