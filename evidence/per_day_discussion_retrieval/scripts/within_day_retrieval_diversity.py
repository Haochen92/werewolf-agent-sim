...
churn is decoupled from what the query says — retrieval-side noise, not situation adaptation.
    ...
    poetry run python evidence/per_day_discussion_retrieval/scripts/within_day_retrieval_diversity.py

Output: evidence/per_day_discussion_retrieval/data/within_day_retrieval_diversity.json + stdout table.
"""
...
OUT = REPO_ROOT / "evidence/per_day_discussion_retrieval/data/within_day_retrieval_diversity.json"
