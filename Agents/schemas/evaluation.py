...
class EvalCase(BaseModel):
    ...
    signal. Empty when memory was off or no SPs retrieved. Carried internally on TurnEffects."""
    ...
    retrieved. Carried internally on TurnEffects."""
    ...
    (pre-2026-07-09) and on wolf-night turns (out of the shipped scope). Carried internally on
    TurnEffects and consumed by the parked reads-scoring +
