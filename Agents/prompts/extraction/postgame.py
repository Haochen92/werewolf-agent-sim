"""LIVE v5 post-game memory extraction: the whole-game POSTGAME prompt + the per-role fan-out
(role-neutral cached PREFIX + role-lock TAIL + the namespace-augmentation phase TAIL). This is the
CURRENT production extraction (orchestrator postgame node); v6 cell extraction is offline-only."""
