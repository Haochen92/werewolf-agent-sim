...
# (evaluation/src/studies/reextract_villager_day.py); the live extraction prompts are untouched.
...
# The original MONOLITHIC v6 cell extraction prompt (pre prefix/tail). Superseded by the cached
# CELL_EXTRACTION_PREFIX + CELL_OBSERVATION_TAIL split (cell.py); kept here for reference only.
