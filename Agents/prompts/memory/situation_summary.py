"""Situation-summary prompts: the live retrieval QUERY the agent composes before retrieving
memory. V6_SITUATION_SUMMARY (v6 cell-aligned) is current; the per-role *_SITUATION_SUMMARY are
the legacy v5 fallbacks for any (role, phase) without a v6 cell."""
