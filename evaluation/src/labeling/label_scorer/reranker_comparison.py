...
def _format_obs_text(fields: dict) -> str:
    """Same as Agents/memory/retrieval/rerank_agent.py:_format_observation_candidate."""
...
def _format_sp_text(fields: dict) -> str:
    """Same as Agents/memory/retrieval/rerank_agent.py:_format_strategy_point_candidate."""
