...
shows the lever, the full DAG + live rewiring follow.
  ...
  poetry run python evaluation/src/experiments/reextract_villager_day.py --limit 2   # smoke
  poetry run python evaluation/src/experiments/reextract_villager_day.py             # full 20 games
"""
